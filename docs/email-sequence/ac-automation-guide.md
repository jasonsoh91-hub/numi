...
| `{{calendar_link}}` | `https://calendar.google.com/calendar/render?action=TEMPLATE&text=NUMI+Masterclass+-+Decode+Your+Life+Pattern&details=A+free+60-minute+live+NUMI+masterclass.+Bring+your+birth+date.&dates=20260722T020000Z/20260722T030000Z` |
...
│  → B1 send immediately                                           │
│  → wait until 2026-07-20 10:00 EDT (24h before) → B2 (24h before)             │
│  → wait until 2026-07-21 21:00 EDT (1h before) → B3 (1h before)              │
│  → wait until 2026-07-21 22:00 EDT (= 7:00 PM PST) → B4 (at start)               │
│  → end                                                           │
└──────────────────────────────────────────────────────────────────┘
...
│           `webinar-attended`)                                    │
│  Start date: 2026-07-22 00:00 EDT (2h after end) (2hr after webinar end)        │
│  → C1 send immediately                                           │
...
**Send:** 2026-07-20 10:00 EDT (24h before) (schedule via AC "Wait Until Date" node)
...
**Send:** 2026-07-21 21:00 EDT (1h before)
...
**Send:** 2026-07-21 22:00 EDT (= 7:00 PM PST)
...
**Automation start:** 2026-07-22 00:00 EDT (2h after end) (2h after event end).

## C1 · Replay + Re-Invite

**Send:** Immediately when entered segment (~2026-07-22 00:00 EDT (2h after end))
...
**Send:** +46 hours after C1 (~2026-07-23 22:00 EDT)
