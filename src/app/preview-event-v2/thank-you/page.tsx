...
import { Check, Mail, Calendar, ArrowRight, Home, Gift } from "lucide-react";

export default function ThankYouV2Page() {
          ...
          >
            ...
            <motion.div variants={fadeInUp}>
              ...
              <p className="text-lg md:text-xl text-gray-600 max-w-xl mx-auto leading-relaxed">
                Your spot is reserved. Check your email — we just sent you the masterclass details and a little something extra.
              </p>
            </motion.div>
            ...
            >
              ...
              <div className="bg-gray-50 rounded-2xl p-6 text-left">
                ...
                <p className="text-sm text-gray-600">
                  We sent your masterclass access link and Pattern Code preview to <span className="font-medium text-gray-900">{registrationData?.email || "your email"}</span>
                </p>
              </div>
              ...
              <div className="bg-[#D8B86A]/10 border border-[#D8B86A]/20 rounded-2xl p-6 text-left">
                <div className="w-12 h-12 mb-4 rounded-xl bg-[#D8B86A]/20 flex items-center justify-center">
                  <Gift className="w-6 h-6 text-[#D8B86A]" />
                </div>
                <h3 className="font-bold text-gray-900 mb-2">Free Bonus Inside</h3>
                <p className="text-sm text-gray-600">
                  Included: A quick-start guide to understanding your personal Pattern Code before the masterclass.
                </p>
              </div>
            </motion.div>
            ...
            >
              <h3 className="text-lg md:text-xl font-bold text-gray-900 mb-6">What's Next:</h3>
              <ul className="space-y-4">
                {[
                  "Check your email for the confirmation (check spam if you don't see it within 5 minutes)",
                  "Click the link to access the masterclass platform",
                  "Download your free Pattern Code guide",
